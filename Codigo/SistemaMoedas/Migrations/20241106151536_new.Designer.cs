...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaMoedas.Classes.Aluno", b =>
                {
                    ...
                    b.Property<int>("CursoAlunoCodigoCurso")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InstituicaoAlunoCodigoInstituicao")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CursoAlunoCodigoCurso");

                    b.HasIndex("InstituicaoAlunoCodigoInstituicao");
            ...
            modelBuilder.Entity("SistemaMoedas.Classes.Aluno", b =>
                {
                    b.HasOne("SistemaMoedas.Classes.Curso", "CursoAluno")
                        .WithMany()
                        .HasForeignKey("CursoAlunoCodigoCurso")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaMoedas.Classes.Instituicao", "InstituicaoAluno")
                        .WithMany()
                        .HasForeignKey("InstituicaoAlunoCodigoInstituicao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CursoAluno");

                    b.Navigation("InstituicaoAluno");
                });
